...
public class CalculatorTest {
    private final static Object[][] CORRECT_TEST_DATA = {
            ...
            {"00..65 + 23", null, "Unhandled lexeme."},
    ...
    public void testCorrectAnswer() throws Exception {
        ...
        if (varValue == null)
            Assert.assertEquals(Calc.response(new String[]{input}), expected);
        else
            Assert.assertEquals(Calc.response(new String[]{input, varValue}), expected);
    }
}