...
public class Expression {
    ...
    private final boolean VariableExpected;
    ...
    public static void analyze(final List<Lexeme> input) throws WrongSyntaxException {
        ...
        if (brackets + input.get(last).handleIfBracket() != 0)
            throw new BracketsBalanceException();
    ...
    public boolean VariableExpected() {
        return root.VariableExpected();
    }
    ...
    private Function buildNode(final List<Lexeme> expression) {
        final List<Lexeme> exp = ExpressionUtilities.simplifyExpression(expression);
        Function node = null;
        int fracture;
    ...
    public static class Parser {
        ...
        public static final String RE_UNUM = "(\\d+(\\.\\d+)?)";
        public static final String RE_NUM = "(\\-?" + RE_UNUM + ")";
        public static final String RE_RANGE = RE_NUM + ":?" + RE_NUM + "(:?" + RE_NUM + ")?";
    ...
    protected class DivOperation implements Function {
        ...
        @Override
        public boolean VariableExpected() {
            return (lChild.VariableExpected() || rChild.VariableExpected());
        }
    }
